 ...
 */
final class Version20200425094751 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trn_expenses (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, account_name VARCHAR(255) NOT NULL, user_name VARCHAR(255) NOT NULL, reporting_date DATETIME NOT NULL, price NUMERIC(12, 2) NOT NULL, qty NUMERIC(10, 2) NOT NULL, registrate_date DATETIME DEFAULT NULL, settled_date DATETIME DEFAULT NULL, note VARCHAR(255) DEFAULT NULL)');
